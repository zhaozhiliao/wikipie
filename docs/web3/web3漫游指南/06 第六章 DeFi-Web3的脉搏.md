...
上述内容已经带我们逐渐踏入 DeFi2.0 的门槛了。下图是一张 Web3 金融进击图，比较清晰得把这个行业一路走来的样子给画了出来。
